...
import { nullifyTransform, smartTransform } from './services/transformer';
  ...
  return (
    <div className="min-h-screen flex flex-col p-4 md:p-8 max-w-7xl mx-auto">
      ...
      <div className="flex flex-wrap gap-4 mb-6">
        ...
        >
          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="group-hover:rotate-12 transition-transform"><circle cx="12" cy="12" r="10"/><line x1="4.93" x2="19.07" y1="4.93" y2="19.07"/></svg>
          Transform to Null
        </button>
        <button
        ...
        >
          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="group-hover:scale-110 transition-transform"><path d="M12 2v8"/><path d="m16 6-4 4-4-4"/><rect width="20" height="8" x="2" y="14" rx="2"/></svg>
          Smart Transform
        </button>
        <button
          onClick={clearAll}
            ...
            {state.error ? (
              <div className="w-full h-full bg-red-900/10 border border-red-500/50 p-4 text-red-400 font-medium rounded-b-lg flex items-center justify-center">
                <div className="text-center">
                   <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="mx-auto mb-4 opacity-50"><circle cx="12" cy="12" r="10"/><line x1="12" x2="12" y1="8" y2="12"/><line x1="12" x2="12.01" y1="16" y2="16"/></svg>
                   {state.error}
                </div>
              </div>
            ) : (
      ...
      {/* Footer Info */}
      <footer className="mt-8 pt-6 border-t border-slate-800 flex flex-col md:flex-row justify-between items-center text-slate-500 text-sm gap-4">
        <div className="flex items-center gap-6">
          <div className="flex items-center gap-2">
            <div className="w-2 h-2 rounded-full bg-emerald-500"></div>
            <span>Ready for Processing</span>
          </div>
          <p>Local Processing (Privacy Guaranteed)</p>
        </div>
        <div className="flex gap-4">
          <span className="hover:text-slate-300 transition-colors cursor-help border-b border-dotted border-slate-600">Smart Mapping Rules: String→"" | Number→0/-Random | Date→TimestampZ</span>
        </div>
      </footer>
    </div>
  );
